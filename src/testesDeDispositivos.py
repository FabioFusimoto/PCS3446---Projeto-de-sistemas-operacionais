...
print('\r\n2)-----INSERINDO SOLICITAÇÕES DE ACESSO A E0 E S0, ATUALIZANDO E VERIFICANDO O ESTADO APÓS ATUALIZAÇÃO----')
GD.solicitarES('E0', 'A')
GD.solicitarES('S0', 'C')
houveAtualizacao, mensagem, jobsQueIniciaramES, jobsQueFinalizaramES = GD.atualizar()
if(houveAtualizacao):
    print(mensagem)
GD.mostrarEstado()

print('\r\n3)-----ATUALIZANDO POR VÁRIOS CICLOS E VERIFICANDO MUDANÇAS E O ESTADO DOS DISPOSITIVOS APÓS AS MUDANÇAS----')
